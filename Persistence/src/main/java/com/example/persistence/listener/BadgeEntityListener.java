...
import com.example.persistence.config.Action;
import com.example.persistence.history.BadgeHistory;
import com.example.persistence.model.Badge;
import com.example.persistence.util.BeanUtil;
...
import static com.example.persistence.config.Action.*;
